...
\titulo{Análise de Sentimento em Publicações Financeiras do X/Twitter: Uma Avaliação Comparativa de Léxicos e Modelos BERT no Mercado Brasileiro}
\titleabstract{Sentiment Analysis of Financial Publications on X/Twitter: A Comparative Evaluation of Lexicons and BERT Models in the Brazilian Market}
\tituloadic{Sentiment Analysis of Financial Publications on X/Twitter: A Comparative Evaluation of Lexicons and BERT Models in the Brazilian Market}
\tituloresumo{Análise de Sentimento em Publicações Financeiras do X/Twitter: Uma Avaliação Comparativa de Léxicos e Modelos BERT no Mercado Brasileiro}
