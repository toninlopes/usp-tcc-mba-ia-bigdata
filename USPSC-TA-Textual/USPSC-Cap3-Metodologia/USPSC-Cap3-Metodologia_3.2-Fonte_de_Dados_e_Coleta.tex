...
O \textit{pipeline} de coleta é a primeira etapa de uma estrutura modular de seis estágios. Os módulos que compõem essa etapa, com suas responsabilidades bem delimitadas, são:
