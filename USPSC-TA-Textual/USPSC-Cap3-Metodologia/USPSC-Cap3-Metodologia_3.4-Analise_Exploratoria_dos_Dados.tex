...
Ambos os módulos obtêm os dados diretamente do banco de dados PostgreSQL via \texttt{app/shared/db/database.py}, com o auxílio das bibliotecas \texttt{pandas} \cite{pandas2020}, \texttt{plotly} e \texttt{streamlit}. Os resultados das subseções a seguir são provenientes do módulo \texttt{eda.py}.
